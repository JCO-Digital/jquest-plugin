...
final class Type
{
	...
	private static function fromReflectionType(\ReflectionType $type, $of, bool $asObject): self|string
	{
		if ($type instanceof \ReflectionNamedType) {
			...
			throw new \JcoreBroiler\Nette\InvalidStateException('Unexpected type of ' . Reflection::toString($of));
		}
	}
	...
	public static function fromString(string $type): self
	{
		if (!Validators::isTypeDeclaration($type)) {
			throw new \JcoreBroiler\Nette\InvalidArgumentException("Invalid type '$type'.");
		}
