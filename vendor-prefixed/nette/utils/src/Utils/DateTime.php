...
class DateTime extends \DateTime implements \JsonSerializable
{
	 ...
	 * @throws JcoreBroiler\Nette\InvalidArgumentException if the date and time are not valid.
	 */
	...
	): static
	{
		...
		if (
			...
			throw new \JcoreBroiler\Nette\InvalidArgumentException("Invalid date '$s'");
		}
