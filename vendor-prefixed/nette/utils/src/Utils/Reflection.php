...
final class Reflection
{
	...
	/** @deprecated use JcoreBroiler\Nette\Utils\Validator::isBuiltinType() */
	...
	/** @deprecated use JcoreBroiler\Nette\Utils\Validator::isClassKeyword() */
	...
	public static function toString(\Reflector $ref): string
	{
		if ($ref instanceof \ReflectionClass) {
			...
			throw new JcoreBroiler\Nette\InvalidArgumentException;
		}
	}
	 ...
	 * @throws JcoreBroiler\Nette\InvalidArgumentException
	 */
	public static function expandClassName(string $name, \ReflectionClass $context): string
	{
		$lower = strtolower($name);
		if (empty($name)) {
			throw new \JcoreBroiler\Nette\InvalidArgumentException('Class name must not be empty.');
	...
	public static function getUseStatements(\ReflectionClass $class): array
	{
		if ($class->isAnonymous()) {
			throw new \JcoreBroiler\Nette\NotImplementedException('Anonymous classes are not supported.');
		}
	...
	{
		try {
			$tokens = \JcoreBroiler_PhpTokenPhpToken;
		} catch (\ParseError $e) {
