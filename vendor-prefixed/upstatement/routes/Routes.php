<?php
/*
Plugin Name: JcoreBroiler_Routes
Plugin URI: http://www.upstatement.com
Description: JcoreBroiler_Routes makes it easy to add custom routing to your WordPress site. That's why we call it JcoreBroiler_Routes. That is all.
...
JcoreBroiler_Routes::map('/my-location', function(){
	//do stuff
	JcoreBroiler_Routes::load('single.php', $data);
});
*
@license MIT
...
class JcoreBroiler_Routes {
	 ...
	 *                              JcoreBroiler_Routes::map('myfoo', 'my_callback_function');
	 *                              JcoreBroiler_Routes::map('mybaq', array($my_class, 'method'));
	 *                              JcoreBroiler_Routes::map('myqux', function() {
	 *                                  //stuff goes here
	 *                              });
	 */
	public static function map($route, $callback, $args = array()) {
		global $upstatement_routes;
		if (!isset($upstatement_routes->router)) {
			$upstatement_routes->router = new JcoreBroiler_AltoRouter();
	...
	/**
	 * @return string 					A string in a format for JcoreBroiler_AltoRouter
	 *                       			ex: [:my_param]
	 */
...
global $upstatement_routes;
$upstatement_routes = new JcoreBroiler_Routes();
