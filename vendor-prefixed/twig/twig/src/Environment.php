...
namespace JcoreBroiler\Twig;

use JcoreBroiler\Twig\Cache\CacheInterface;
use JcoreBroiler\Twig\Cache\FilesystemCache;
...
use JcoreBroiler\Twig\Loader\ArrayLoader;
...
class Environment
{
    ...
    public function __construct(LoaderInterface $loader, $options = [])
    {
        ...
        if ('\\'.Template::class !== $this->baseTemplateClass && '\JcoreBroiler_Twig_TemplateTwig_Template\E_USER_DEPRECATED);
        }
    ...
    public function load($name)
    {
        ...
        if ($name instanceof Template) {
            @trigger_error('Passing a \Twig\Template instance to '.__METHOD__.' is deprecated since Twig 2.7.0, use \JcoreBroiler\Twig\TemplateWrapper instead.', \E_USER_DEPRECATED);
...
class_alias('JcoreBroiler\Twig\Environment', 'Twig_Environment');
