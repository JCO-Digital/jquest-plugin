...
use JcoreBroiler\Twig\Node\Expression\Binary\AndBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\BitwiseAndBinary;
...
use JcoreBroiler\Twig\Node\Expression\Binary\GreaterBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\GreaterEqualBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\InBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\LessBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\LessEqualBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\MatchesBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\ModBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\MulBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\NotEqualBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\NotInBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\OrBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\PowerBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\RangeBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\SpaceshipBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\StartsWithBinary;
use JcoreBroiler\Twig\Node\Expression\Binary\SubBinary;
use JcoreBroiler\Twig\Node\Expression\Filter\DefaultFilter;
use JcoreBroiler\Twig\Node\Expression\NullCoalesceExpression;
use JcoreBroiler\Twig\Node\Expression\Test\ConstantTest;
use JcoreBroiler\Twig\Node\Expression\Test\DefinedTest;
use JcoreBroiler\Twig\Node\Expression\Test\DivisiblebyTest;
use JcoreBroiler\Twig\Node\Expression\Test\EvenTest;
use JcoreBroiler\Twig\Node\Expression\Test\NullTest;
use JcoreBroiler\Twig\Node\Expression\Test\OddTest;
use JcoreBroiler\Twig\Node\Expression\Test\SameasTest;
use JcoreBroiler\Twig\Node\Expression\Unary\NegUnary;
use JcoreBroiler\Twig\Node\Expression\Unary\NotUnary;
use JcoreBroiler\Twig\Node\Expression\Unary\PosUnary;
use JcoreBroiler\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use JcoreBroiler\Twig\TokenParser\ApplyTokenParser;
...
use JcoreBroiler\Twig\TokenParser\EmbedTokenParser;
use JcoreBroiler\Twig\TokenParser\ExtendsTokenParser;
use JcoreBroiler\Twig\TokenParser\FilterTokenParser;
use JcoreBroiler\Twig\TokenParser\FlushTokenParser;
use JcoreBroiler\Twig\TokenParser\ForTokenParser;
use JcoreBroiler\Twig\TokenParser\FromTokenParser;
...
use JcoreBroiler\Twig\TokenParser\SetTokenParser;
use JcoreBroiler\Twig\TokenParser\SpacelessTokenParser;
use JcoreBroiler\Twig\TokenParser\UseTokenParser;
...
class_alias('JcoreBroiler\Twig\Extension\CoreExtension', 'Twig_Extension_Core');
}
...
namespace {
    ...
    use JcoreBroiler\Twig\TemplateWrapper;
...
{
    if (!$arrow instanceof Closure && $env->hasExtension('\JcoreBroiler\Twig\Extension\SandboxExtension') && $env->getExtension('\JcoreBroiler\Twig\Extension\SandboxExtension')->isSandboxed()) {
