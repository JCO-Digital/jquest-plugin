...
class Parser
{
    ...
    private function filterBodyNodes(Node $node, bool $nested = false)
    {
        ...
        if ($nested && ($node instanceof BlockReferenceNode || $node instanceof \JcoreBroiler_Twig_Node_BlockTwig_Node_Block;
...
class_alias('JcoreBroiler\Twig\Parser', 'Twig_Parser');
