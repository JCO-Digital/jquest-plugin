...
class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use JcoreBroiler\Twig\Environment;\n")
                ->write("use JcoreBroiler\Twig\Error\LoaderError;\n")
                ->write("use JcoreBroiler\Twig\Error\RuntimeError;\n")
                ->write("use JcoreBroiler\Twig\Extension\SandboxExtension;\n")
                ->write("use JcoreBroiler\Twig\Markup;\n")
                ->write("use JcoreBroiler\Twig\Sandbox\SecurityError;\n")
                ->write("use JcoreBroiler\Twig\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use JcoreBroiler\Twig\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use JcoreBroiler\Twig\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use JcoreBroiler\Twig\Source;\n")
                ->write("use JcoreBroiler\Twig\Template;\n\n")
            ;
        }
        $compiler
...
class_alias('JcoreBroiler\Twig\Node\ModuleNode', 'Twig_Node_Module');
